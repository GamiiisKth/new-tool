...
class Header extends Component {
  ...
  render() {
      const {firstName} = this.props.consultantState;
          ...
          <li className="nav-item">
            ...
            <Dropdown isOpen={this.state.dropdownOpen} toggle={this.toggle}>
              ...
              <button onClick={this.toggle} className="nav-link dropdown-toggle" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded={this.state.dropdownOpen}>
                ...
                <span className="d-md-down-none">{firstName}</span>
              </button>

              <DropdownMenu className="dropdown-menu-right">
                <DropdownItem header className="text-center"><strong>Account</strong></DropdownItem>

                <DropdownItem><i className="fa fa-bell-o"></i> Updates<span className="badge badge-info">Hello</span></DropdownItem>
                ...
                <DropdownItem><Link to={'/logout'} className="fa fa-lock"> Logout</Link></DropdownItem>
